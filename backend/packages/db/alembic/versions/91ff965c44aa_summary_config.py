...
Revision ID: 91ff965c44aa
Revises: febc57d54920
Create Date: 2026-06-21 14:56:14.671609
...
revision: str = '91ff965c44aa'
down_revision: Union[str, Sequence[str], None] = 'febc57d54920'
...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('custom_table_meta', sa.Column(
        'summary_config', postgresql.JSONB(astext_type=sa.Text()),
...
def downgrade() -> None:
    ...
    op.drop_column('custom_table_meta', 'summary_config')
