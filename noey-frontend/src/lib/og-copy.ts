...
export const OG_COPY = {
  ...
  pricing: {
    eyebrow: "ราคา",
    title: "ห้าแพลน เลือกตามปริมาณงาน",
    subtitle: "ใช้ฟรีได้ ไม่ต้องผูกบัตร แล้วค่อยขยับตามปริมาณงาน",
    alt: "ราคาและแพลนของ Noey Studio",
  },
  examples: {
    eyebrow: "ตัวอย่างงาน",
    title: "ตัวอย่างคลิปรีวิวสินค้า ตัดด้วย AI",
    subtitle: "โหมดพากย์ใหม่ AI เขียนสคริปต์พากย์ไทยจากภาพ แล้วใส่ซับไทยให้",
    alt: "ตัวอย่างคลิปรีวิวสินค้าที่ตัดด้วย Noey Studio",
  },
  about: {
