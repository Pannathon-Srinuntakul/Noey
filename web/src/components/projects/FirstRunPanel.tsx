...
const MODES = [
  {
    ...
    title: 'ตัดช่วงเงียบ',
    blurb:
      'คลิปพูดหน้ากล้องยาว ๆ ตัดช่วงเงียบและเทคซ้ำออก คงเสียงเดิมไว้ ได้คำบรรยายจากการถอดเสียงให้ด้วย'
  },
  {
    icon: Scissors,
    title: 'ตัดฉากเด่น',
    blurb:
      'เลือกฉากเด่นให้จากหลายคลิป แล้วเลือกได้ว่าจะเขียนสคริปต์เอง ให้ AI ร่างให้ หรือไม่ใช้สคริปต์เลย ใส่เพลงประกอบได้'
  },
  {
    icon: Layers,
